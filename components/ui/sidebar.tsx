...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        "bg-primary text-primary-foreground animate-in fade-in-0 zoom-in-95 z-50 rounded-md px-3 py-1.5 text-xs shadow-md",
        className
      )}
      {...props}
    />
  ...
  if (isMobile) {
    return (
      <div
        ...
        data-mobile="true"
        className={cn(
          "bg-sidebar text-sidebar-foreground fixed inset-y-0 left-0 z-50 flex h-svh flex-col transition-transform duration-200",
...
const sidebarMenuButtonVariants = cva(
  ...
  {
    variants: {
      variant: { default: "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground", outline: "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground" },
...
const SidebarMenuSubButton = ({ asChild = false, size = "md", isActive = false, className, ...props }: React.ComponentProps<"a"> & { asChild?: boolean; size?: "sm" | "md"; isActive?: boolean }) => {
...
export {
  ...
  SidebarMenuAction, SidebarMenuItem, SidebarMenuButton, SidebarMenuSub, SidebarMenuSubButton,
  SidebarMenuSubItem, SidebarProvider, SidebarSeparator, SidebarTrigger, useSidebar,
};
